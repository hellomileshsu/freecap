...
if (command === "bridge") {
  ...
  console.log("\nClaude Code / Codex:");
  console.log("npx -y github:hellomileshsu/freecap#v1 mcp");
  console.log("\nCursor mcp.json:");
  console.log(JSON.stringify({ mcpServers: { freecap: { command: "npx", args: ["-y", "github:hellomileshsu/freecap#v1", "mcp"] } } }, null, 2));
