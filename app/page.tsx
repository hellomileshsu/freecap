...
export default function Home() {
  ...
  const installCommand = "npx -y github:hellomileshsu/freecap#v1.3 mcp";
  const mcpConfig = `{"mcpServers":{"freecap":{"command":"npx","args":["-y","github:hellomileshsu/freecap#v1.3","mcp"]}}}`;
  ...
  return (
    <main className="freecap-shell">
      <header className="topbar">
        ...
        <div className="topbar-meta"><span className="privacy-pill"><span className="status-dot" />本機優先</span><span className="version-label">v0.1.3 · GPL-3.0</span><button className="icon-button" type="button" onClick={() => setShowMcp(true)} aria-label="開啟 MCP 安裝說明">⌘</button></div>
      </header>
